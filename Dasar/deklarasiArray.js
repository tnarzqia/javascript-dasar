...
let buah = new Array("mangga", "apel", "pisang");
// cara mengakses data 
console.log(buah[0]);
//data dari array bisa kita ubah dengan cara 
buah[1] = "Kiwi";
console.log(buah);

// Menggunakan Array Literal
// let namaArray = [ element1, element2, element3 ];
let kelas =  ["meja", "kursi", "buku"];
// untuk mengetahui jumlah data yang ditampung 
console.log(kelas.length);
// index ke-0 meja dan buku = index-ke 2
